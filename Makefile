#############################################################################
# Makefile for building: shtimer
# Generated by qmake (1.07a) (Qt 3.3.8b) on: Sat Sep 27 13:16:49 2008
# Project:  shtimer.pro
# Template: subdirs
# Command: $(QMAKE) -o Makefile shtimer.pro
#############################################################################
...
Makefile: shtimer.pro  /usr/share/qt3/mkspecs/default/qmake.conf 
	$(QMAKE) -o Makefile shtimer.pro
qmake: qmake_all
	@$(QMAKE) -o Makefile shtimer.pro
